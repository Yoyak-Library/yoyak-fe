        ...
        <div className='home__container'>
            ...
            <div id='main'>
                <div className="home__image-container">
                    ...
                    <div className='home__content-description'>학교 폭력으로 인생이 무너진 문동은<br />가해자들에게 복수하기 위해 철저히 준비하며<br />그들의 세계로 다시 들어간다. 그녀의 복수극은 어디로 향할까?</div>
            ...
            <div className="home__summary">
                <div className='home__summary-title'>영화</div>
                <div className='home__summary-component'>
                    <Summary />
                    <Summary />
                    <Summary />
            ...
            <div className="home__summary">
                <div className='home__summary-title'>드라마</div>
                <div className='home__summary-component'>
                    <Summary />
                    <Summary />
                    <Summary />
            ...
            <div className="home__summary">
                <div className='home__summary-title'>회원님을 위한 이번주 인기 영화</div>
                <div className='home__summary-component'>
                    <Summary />
                    <Summary />
                    <Summary />
            ...
            <div className="home__summary">
                <div className='home__summary-title'>TV 프로그램</div>
                <div className='home__summary-component'>
                    <Summary />
                    <Summary />
                    <Summary />
